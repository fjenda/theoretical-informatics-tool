...
<script lang="ts">
    ...
    $: {
        if ($first_backup_store.type == "empty") {
            $first_backup_store.type = "DFA";
        }
    }
...
<div class="toggle-box">
    ...
    <div class="toggle-switch">
        <button
                class={$first_backup_store.type === "DFA" ? 'selected' : ''}
                on:click={() => toggle("DFA")}
        >
            DFA
        </button>
        <button
                class={$first_backup_store.type === "NFA" ? 'selected' : ''}
                on:click={() => toggle("NFA")}
        >
            NFA
        </button>
