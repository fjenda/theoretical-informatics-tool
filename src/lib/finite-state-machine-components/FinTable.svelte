<!--
    FinTable.svelte
    This component is responsible for displaying the table of transitions of the finite automaton.
    Author: Marek Krúpa
-->
...
<script lang="ts">
    ...
    // Subscribe to the stores to get the data from them and update the table data
